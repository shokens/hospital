                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="card-body">
                                <form method="Post" action="{{route('admin.create_doctor')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="text-danger" role="alert"> @error('cpassword') {{ $message }} @enderror</span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name" type="text" class="form-control @error('role') is-invalid @enderror" name="role"  autocomplete="role" autofocus>
