                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Doctors Records</h3>
                                ...
                                <table class="table no-wrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Doctors Name</th>
                                            <th class="border-top-0">Doctors Email</th>
                                            <th class="border-top-0">Doctors Role</th>
                                            <th class="border-top-0">Doctors Gender</th>
                                            <th class="border-top-0">Doctors Number</th>
                                    ...
                                    @foreach($data as $datas)
                                        <tr>
                                            ...
                                            <td>{{$datas->name}}</td>
                                            <td>{{$datas->email}}</td>
                                            <td><span class="text-success">{{$datas->role}}</span></td>
                                            <td>{{$datas->gender}}</td>
                                            <td><span class="text-danger">{{$datas->phone}}</span></td>
                                            <td><a href="{{route ('admin.edit_doctor',$datas->id)}}" class="btn btn-primary">Edit</a>  &nbsp;   </a></td>
                                            <td><a href="delete_doc/{{ $datas->id }}" class="btn btn-danger">Delete</a>  </a></td>
                                        </tr>
