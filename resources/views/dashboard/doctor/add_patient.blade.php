                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="card-body">
                                <form method="Post" action="{{route('doctor.create_user')}}">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control @error('password') is-invalid @enderror" name="cpassword"  autocomplete="new-password">
                                <span class="text-danger" role="alert"> @error('cpassword') {{ $message }} @enderror</span>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="docgender" type="text" class="form-control @error('gender') is-invalid @enderror" name="gender"  autocomplete="name" autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"   autocomplete="name" autofocus>
